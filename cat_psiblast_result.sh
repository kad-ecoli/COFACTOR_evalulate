...
MF_RESULT_gwGOfreq="$OUTDIR/result/psiblast_gwGOfreq_MF.csv"
CC_RESULT_gwGOfreq="$OUTDIR/result/psiblast_gwGOfreq_CC.csv"
BP_RESULT_gwGOfreq="$OUTDIR/result/psiblast_gwGOfreq_BP.csv"
...
MF_RESULT_lwGOfreq="$OUTDIR/result/psiblast_lwGOfreq_MF.csv"
CC_RESULT_lwGOfreq="$OUTDIR/result/psiblast_lwGOfreq_CC.csv"
BP_RESULT_lwGOfreq="$OUTDIR/result/psiblast_lwGOfreq_BP.csv"
...
MF_RESULT_ewGOfreq="$OUTDIR/result/psiblast_ewGOfreq_MF.csv"
CC_RESULT_ewGOfreq="$OUTDIR/result/psiblast_ewGOfreq_CC.csv"
BP_RESULT_ewGOfreq="$OUTDIR/result/psiblast_ewGOfreq_BP.csv"
...
for S in `ls`;do
    if [ -s $S/psiblast_globalID_MF ];then
        ...
        cat $S/psiblast_gwGOfreq_MF|sed "s/^/$S\t/g" >> $MF_RESULT_gwGOfreq
        cat $S/psiblast_lwGOfreq_MF|sed "s/^/$S\t/g" >> $MF_RESULT_lwGOfreq
        cat $S/psiblast_ewGOfreq_MF|sed "s/^/$S\t/g" >> $MF_RESULT_ewGOfreq
    fi
    if [ -s $S/psiblast_globalID_BP ];then
        ...
        cat $S/psiblast_gwGOfreq_BP|sed "s/^/$S\t/g" >> $BP_RESULT_gwGOfreq
        cat $S/psiblast_lwGOfreq_BP|sed "s/^/$S\t/g" >> $BP_RESULT_lwGOfreq
        cat $S/psiblast_ewGOfreq_BP|sed "s/^/$S\t/g" >> $BP_RESULT_ewGOfreq
    fi
    if [ -s $S/psiblast_globalID_CC ];then
        ...
        cat $S/psiblast_gwGOfreq_CC|sed "s/^/$S\t/g" >> $CC_RESULT_gwGOfreq
        cat $S/psiblast_lwGOfreq_CC|sed "s/^/$S\t/g" >> $CC_RESULT_lwGOfreq
        cat $S/psiblast_ewGOfreq_CC|sed "s/^/$S\t/g" >> $CC_RESULT_ewGOfreq
    fi
done
